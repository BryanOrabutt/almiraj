...
BINARY_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'target.bin.bak')

# Memory map for the code to be tested
CODE_ADDRESS  = 0x80000000  # BBB image has entry point at 0x80000000. Assuming this is correct?
...
DATA_ADDRESS  = 0x00030000  # Address where mutated data will be placed
